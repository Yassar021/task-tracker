  ...
  return (
    <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
      <div className="space-y-6">
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-gray-600 dark:text-gray-400">
              Halo, {session?.user?.name || 'Guru'}! Kelola tugas dan ujian untuk kelas Anda.
            </p>
          </div>
          <div className="flex items-center gap-2">
            <Button onClick={openAssignmentForm} className="bg-blue-600 hover:bg-blue-700 text-white">
        ...
        {/* System Rules Banner */}
        <Card className="border-l-4 border-blue-500 bg-blue-50/50 dark:bg-blue-900/10 dark:border-blue-600">
          <CardHeader className="pb-3">
            <div className="flex items-center gap-3">
              ...
              <div>
                <CardTitle className="text-lg text-blue-900 dark:text-blue-300">Aturan Sistem Minggu Ini</CardTitle>
          ...
          <CardContent className="pt-0">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="flex items-center gap-4 p-4 bg-blue-100/50 dark:bg-blue-900/20 rounded-lg">
                <div className="h-12 w-12 rounded-lg bg-blue-100 dark:bg-blue-900/20 flex items-center justify-center">
                  <FileText className="h-6 w-6 text-blue-600 dark:text-blue-400" />
                </div>
                <div>
                  <div className="font-medium text-blue-900 dark:text-blue-300">
                    Maksimal Tugas per Kelas
                  </div>
                  <div className="text-2xl font-bold text-blue-700 dark:text-blue-400">
                    {systemSettings.maxWeeklyTasks} tugas/minggu
                  </div>
                </div>
              </div>
              <div className="flex items-center gap-4 p-4 bg-blue-100/50 dark:bg-blue-900/20 rounded-lg">
                ...
                <div>
                  <div className="font-medium text-blue-900 dark:text-blue-300">
                    Maksimal Ujian per Kelas
                  </div>
                  <div className="text-2xl font-bold text-blue-700 dark:text-blue-400">
                    {systemSettings.maxWeeklyExams} ujian/minggu
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="space-y-6">
          ...
          <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
            {classStatuses.map((status) => {
              ...
              return (
                <Card key={status.class.id} className={`shadow-sm border-0 bg-white dark:bg-gray-800 transition-all hover:shadow-md ${
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <CardDescription className="mt-1 text-gray-600 dark:text-gray-400">
                        Daftar tugas dan ujian yang telah Anda buat
                      </CardDescription>
                    </div>
                    <Button onClick={openAssignmentForm} variant="outline" size="sm" className="border-gray-200 dark:border-gray-700">
                      <Plus className="h-4 w-4 mr-2" />
                      Tambah Baru
                    </Button>
                  </div>
                  ...
                  <div className="space-y-4">
                    {assignments.filter(a => a.teacherId === session?.user?.id).length === 0 ? (
                      <div className="text-center py-16 text-gray-500 dark:text-gray-400">
                        ...
                        <p className="text-sm mb-6 max-w-md mx-auto text-gray-600 dark:text-gray-400">
                          Mulai buat tugas atau jadwalkan ujian untuk kelas Anda
                        </p>
                        <Button onClick={openAssignmentForm} className="bg-blue-600 hover:bg-blue-700 text-white">
                          <Plus className="h-4 w-4 mr-2" />
                          Buat Tugas Pertama
            ...
            <div className="space-y-6">
              ...
              <Card className="shadow-sm border-0 bg-white dark:bg-gray-800">
                ...
                <CardContent className="pt-0 space-y-3">
                  <Button onClick={openAssignmentForm} className="w-full bg-blue-600 hover:bg-blue-700 text-white">
                    <FileText className="h-4 w-4 mr-2" />
                    Buat Tugas Baru
                  </Button>
                  <Button onClick={openAssignmentForm} variant="outline" className="w-full border-gray-200 dark:border-gray-700">
                    ...
                    <div>
                      ...
                      <div className="w-full bg-gray-200 dark:bg-gray-700 rounded-full h-2">
                        <div
                          ...
                          style={{
                            width: `${(() => {
                              const totalTasks = assignments.filter(a => a.type === 'TUGAS' && a.teacherId === session?.user?.id).length;
                              const gradedTasks = assignments.filter(a => a.status === 'graded' && a.teacherId === session?.user?.id).length;
                              const percentage = totalTasks > 0 ? (gradedTasks / totalTasks) * 100 : 0;
                              return percentage;
                            })()}%`
                          }}
                        />
